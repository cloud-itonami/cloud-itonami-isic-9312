# Operator Quickstart — Activities of sports clubs

Shortest path from clone to a verified local dry-run for **ISIC 9312** (`cloud-itonami-isic-9312`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9312.git
cd cloud-itonami-isic-9312
```
...
- Blueprint governor key: `membership-governor`
- Likely source path: `sportsclub.governor.cljc`
